 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://tektutor.org", wsdlLocation = "http://localhost:8080/CalculatorSOAP/services/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://tektutor.org", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorSOAP/services/Calculator?wsdl");
    ...
    public Calculator getCalculator() {
        return super.getPort(new QName("http://tektutor.org", "Calculator"), Calculator.class);
    }
    ...
    public Calculator getCalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://tektutor.org", "Calculator"), Calculator.class, features);
    }
